	...
	public:
		...
		*/
		string to_string() const{
			...
			string toReturn="START: "+std::to_string(static_cast<long long>(start))+"\n"+
							"END:   "+std::to_string(static_cast<long long>(end))  +"\n";
		...
		*/
		string to_string_lite() const{
			...
			return std::to_string(static_cast<long long>(start))+","+ std::to_string(static_cast<long long>(end));
	...
	public:
		...
		*/
		string to_string(){
			...
			if(this==NULL){
				...
				"Gap opening:        "+std::to_string(static_cast<long long>(gapOpening))+"\n"+
				"Gap extension:      "+std::to_string(static_cast<long long>(gapExtension))+"\n"+
				"Gap ending penalty: "+std::to_string(static_cast<long long>(gapEnding))+"\n"+
				"****************\n"+
				"RESULTS \n"+
				"----------------\n"+
				"Alignment Length: "+std::to_string(static_cast<long long>(alignmentLength))+"\n"+
				...
				for(int i=0; i<totalChunks; i++){
					...
					toReturn = toReturn +
					patternPiece + "    " + std::to_string(static_cast<long long>(80*(i+1))) + "\n"+
					markupPiece + "    \n"+
					subjectPiece + "    \n\n";
				}
				...
				if(lastChunkLength>0){
					...
					toReturn = toReturn +
					patternPiece + "    " + std::to_string(static_cast<long long>(alignmentLength)) + "\n"+
					markupPiece + "    \n"+
					subjectPiece + "    \n";
				}
				...
				"MUTANT INFO \n"+
				"----------------\n"+
				"Total Insertions: "+std::to_string(static_cast<long long>(totalInsertions))+"\n"+
				"Total Deletions:  "+std::to_string(static_cast<long long>(totalDeletions))  +"\n"+
				"Total Mismatches: "+std::to_string(static_cast<long long>(totalMismatches)) +"\n"+
				"----------------\n"+
				"INSERTIONS: \n"+
				"----------------\n";
		...
		*/
		string to_ggplot2_string(){
			...
			toReturn += "@" + std::to_string(static_cast<long long>(totalInsertions)) + "@";
			...
			toReturn += "@" + std::to_string(static_cast<long long>(totalDeletions)) + "@";
...
int align(int** grid, int** vertical, int** horizontal, char** tracebackGrid,
	...
	*/
	...
	myResult = new Alignment_Result(sequencePattern, sequenceSubject, matrix, gapOpening,
	                       ...
	                       insertions, deletions, deletionsSubject);
