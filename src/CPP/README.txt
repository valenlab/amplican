...
What I'm doing now is, the "nw.h" file that is in /src/CPP (here) is copy into /src/tutorial and renamed to "nw.cpp".
...
The final mission is to get Rcpp to work with nw.h with the constant headers. But until then, follow this instructions.
