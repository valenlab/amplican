...
vignette: >
  %\VignetteIndexEntry{example group_report report}
...
ggplot(data = config, aes(x = as.factor(Group), y = frameshift_percentage_over, order = Group, fill = Group)) +
  geom_boxplot() +
  xlab('Group') + 
...
for(i in unique(config$Group)) {
  cat(paste0("\n\n## ", paste0("Group ", i), "  \n"))
  cat("### Deletions  \n")
  print(amplican::metaplot_deletions(alignments, config, "Group", i))
  cat("\n\n### Insertions  \n")
  print(amplican::metaplot_insertions(alignments, config, "Group", i))
  cat("\n\n### Mismatches  \n")
  print(amplican::metaplot_mismatches(alignments, config, "Group", i))
}
```
