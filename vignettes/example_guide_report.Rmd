...
vignette: >
  %\VignetteIndexEntry{example guide_report report}
...
ggplot(data = config, aes(x = as.factor(guideRNA), y = frameshift_percentage_over, order = guideRNA, fill = guideRNA)) +
  geom_boxplot() +
  xlab('guideRNA') + 
...
```{r plot alignments, echo = F, results = 'asis', echo=F, message=F, warning=F}
for(i in unique(config$guideRNA)) {
  cat(paste0("\n\n## ", paste0("Guide ", i), "  \n"))
  cat("### Deletions  \n")
  print(amplican::metaplot_deletions(alignments, config, "guideRNA", i))
  cat("\n\n### Insertions  \n")
  print(amplican::metaplot_insertions(alignments, config, "guideRNA", i))
  cat("\n\n### Mismatches  \n")
  print(amplican::metaplot_mismatches(alignments, config, "guideRNA", i))
}
```
