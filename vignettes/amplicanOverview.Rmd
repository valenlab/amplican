...
cut region) might be higher than that you have to adjust threshold value to higher levels 
(min_freq input parameter). In case where you expect index hopping to occour, you 
can use either `?amplican::amplicanPipelineIndexHopping` or rise the min_freq 
above expected index hopping level.
