...
You can find example config file at: `r system.file("extdata", "config.csv", package = "amplican")`
...
During `amplicanAnalysis` or `amplicanPipeline` these columns are added to the config file:  
...
# you can run this as example how to knit file:
