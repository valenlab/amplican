...
performed experiment, on later stage it is possible to generate report with breakdown using this field  
 ...
 - **Donor** - insert donor template if you have designed HDR experiments, otherwise leave empty, but keep the column. `amplican` will estimate HDR efficiency based on the events from aligning donor and amplicon sequences, donor and reads and reads and amplicon.  
