...
results_folder <- tempdir()  # output folder
...
```{r, echo=FALSE}
alignments <- system.file("extdata", "results", "alignments.csv", package = "amplican")
...
```{r, echo=FALSE}
hr_alignments <- system.file("extdata", "results", "alignments", "ID_1_barcode_1", "alignments.txt", package = "amplican")
...
```{r, echo=FALSE}
hrd_alignments <- system.file("extdata", "results", "alignments", "ID_1_barcode_1", "detailed_alignments.txt", package = "amplican")
readLines(hrd_alignments, n = 89)
```
