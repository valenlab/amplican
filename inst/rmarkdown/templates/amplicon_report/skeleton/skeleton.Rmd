...
src = sapply(seq_along(uniqueAmlicons), function(i) {
  ...
  knitr::knit_expand(text = c(
    ...
    paste('amplican::plot_deletions(alignments, config, {{ID}},',
          ' params$cut_buffer, params$xlab_spacing)', collapse = ''), 
    '```\n',
    "### Insertions", 
    paste('```{r ins-{{i}}, echo = F, results = "asis", ',
          'fig.width=25, message=F, warning=F}', collapse = ''), 
    paste('amplican::plot_insertions(alignments, config, {{ID}},',
          ' params$cut_buffer, params$xlab_spacing)', collapse = ''), 
    '```\n', 
    "### Mismatches", 
    paste('```{r mis-{{i}}, echo = F, results = "asis", ',
          'fig.width=25, message=F, warning=F}', collapse = ''), 
    paste('amplican::plot_mismatches(alignments, config, {{ID}},',
          ' params$cut_buffer, params$xlab_spacing)', collapse = ''), 
    '```\n', 
    "### Cuts", 
    ...
    '```\n', 
    "### Variants", 
    paste('```{r var-{{i}}, echo = F, results = "asis", ',
          'message=F, warning=F}', collapse = ''),
    paste('amplican::plot_variants(alignments, config, {{ID}}, ',
